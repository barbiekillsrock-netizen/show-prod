...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ShowProd" },
      { name: "description", content: "O app de palco para músicos profissionais." },
      { property: "og:title", content: "ShowProd" },
      { name: "twitter:title", content: "ShowProd" },
      { property: "og:description", content: "O app de palco para músicos profissionais." },
      { name: "twitter:description", content: "O app de palco para músicos profissionais." },
